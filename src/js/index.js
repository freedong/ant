$(function () {
    (function () {
        var banner = $("#banner"), pic_c = banner.find(".pics"), pics = pic_c.children(), idx_c = banner.find(".idxs"), idxs = idx_c.children(), btns = banner.find(".btns a"), prev = btns.filter(".prev1"), next = btns.filter(".next1"), len = pics.length, idx = 0, prev_i = -1, max_i = len - 1, curr_p = pics.eq(idx), curr_i = idxs.eq(idx), delay = 4000, timeout = -1;
